...
.. container:: abstract
    ...
    So, I recently discovered that something is wrong with Inkscape_
...
After a Google search, I found `these instructions`_ which failed because
...
.. _these instructions: http://trac.macports.org/wiki/howto/InstallingOlderPort
