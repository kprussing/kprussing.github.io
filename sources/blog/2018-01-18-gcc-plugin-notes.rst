...
file.  According to the `GCC internals manual`_, the basic structure
is::
...
googling a different problem and came across `this article
<https://arxiv.org/pdf/1904.02546.pdf>`_.  It looks like they beat me to
the punch.  Oh well.  But at least I have a new project to keep an eye
on!

.. _GCC internals manual: https://gcc.gnu.org/onlinedocs/gccint/
